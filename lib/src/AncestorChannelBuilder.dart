...
import 'ChannelSignal.dart';
  ...
  ///  )
  /// ```
class AncestorChannelBuilder<C extends StateChannel<S>, S extends ChannelSignal> extends StatefulWidget {
...
/// [condition] is optional and if it isn't implemented, it will default to `true`.
  ...
  @override
  _AncestorChannelBuilderState<C, S> createState() => _AncestorChannelBuilderState<C, S>();
}

class _AncestorChannelBuilderState<C extends StateChannel<S>,S extends ChannelSignal> extends State<AncestorChannelBuilder<C, S>> {
