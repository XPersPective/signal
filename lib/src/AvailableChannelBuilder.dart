...
class AvailableChannelBuilder<C extends StateChannel<S>, S extends ChannelSignal> extends StatefulWidget {
  ...
  @override
  _AvailableChannelBuilderState<C, S> createState() =>_AvailableChannelBuilderState<C, S>();
}

class _AvailableChannelBuilderState<C extends StateChannel<S>, S extends ChannelSignal> extends State<AvailableChannelBuilder<C, S>> {
